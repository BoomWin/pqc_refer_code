...
// 상수 정의 - api.h 에서 가져옴
#define PK_BYTES PQCLEAN_MLDSA65_CLEAN_CRYPTO_PUBLICKEYBYTES   
#define SK_BYTES PQCLEAN_MLDSA65_CLEAN_CRYPTO_SECRETKEYBYTES 
#define SIG_BYTES PQCLEAN_MLDSA65_CLEAN_CRYPTO_BYTES           
...
int do_verify(const char *pk_hex, const char *msg_hex, const char *sig_hex) {
    ...
    int result = PQCLEAN_MLDSA65_CLEAN_crypto_sign_verify(sig, SIG_BYTES, msg, msg_len, pk);
