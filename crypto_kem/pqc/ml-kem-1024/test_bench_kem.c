...
/* ML-KEM (PQClean 스타일) */
#define BENCH_PK_BYTES  PQCLEAN_MLKEM1024_CLEAN_CRYPTO_PUBLICKEYBYTES
#define BENCH_SK_BYTES  PQCLEAN_MLKEM1024_CLEAN_CRYPTO_SECRETKEYBYTES
#define BENCH_CT_BYTES  PQCLEAN_MLKEM1024_CLEAN_CRYPTO_CIPHERTEXTBYTES
#define BENCH_SS_BYTES  PQCLEAN_MLKEM1024_CLEAN_CRYPTO_BYTES
#define BENCH_ALGNAME   PQCLEAN_MLKEM1024_CLEAN_CRYPTO_ALGNAME

/* ML-KEM (PQClean 스타일) */
#define BENCH_KEYPAIR(pk, sk)       PQCLEAN_MLKEM1024_CLEAN_crypto_kem_keypair(pk, sk)
#define BENCH_ENC(ct, ss, pk)       PQCLEAN_MLKEM1024_CLEAN_crypto_kem_enc(ct, ss, pk)
#define BENCH_DEC(ss, ct, sk)       PQCLEAN_MLKEM1024_CLEAN_crypto_kem_dec(ss, ct, sk)
