...
#define PK_BYTES CRYPTO_PUBLICKEYBYTES // 864
#define SK_BYTES CRYPTO_SECRETKEYBYTES // 1760
#define CT_BYTES CRYPTO_CIPHERTEXTBYTES // 864
...
// coins: NTRUPLUS_N/8 bytes (72 bytes = 144 hex chars for 576)
// ============================================================
